									...
									if (x(I, N, C)) {
										L
												.html('<span class="badge badge-today">'
														+ C + "</span><br/><br/>") //보유가능대수 표시
									}
								}
								var J = $('<td id="' + O + '"></td>');
								J.append(L);
								J.data("date", k(I, N, C));
								J.data("hasEvent", true);
								//★★★★★★★★★ 날짜 클릭 이벤트 처리
...
$.fn.zabuto_calendar_language = function(a) {
	...
	case 'ar':
		return {
			month_labels : [ "يناير", "فبراير", "مارس", "أبريل", "مايو",
					"يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر",
					"ديسمبر" ],
			dow_labels : [ "أثنين", "ثلاثاء", "اربعاء", "خميس", "جمعه", "سبت",
					"أحد" ]
		};
		break;
	case "es":
